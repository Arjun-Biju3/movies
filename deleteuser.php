...
<div class="container"  style="background=">
 ...
 <span class="align-middle" >
    ...
    <div class="colcol-lg-2" style="background-color:#ffffff; padding:40px; border-color:#230237; border-style: solid;border-width: thin;">
      <form method="POST" Action="savedelete1.php">
             
              <div class="form-group">
                  <label for="exampleInputPassword1">ID</label>
                  <input type="text" class="form-control" placeholder="ID OF USER TO BE REMOVED" name="id">
                 
              </div>
              <div class="form-group">
                  <label for="exampleInputSTATION">EMAIL</label>
